...
In the past year I have been working on obtaining a Fully Polynomial Time Approximation Scheme (FPTAS) for the volume of a polytope. Our goal is to design a deterministic algorithm that can compute an epsilon multiplicative approximation of the volume of a polytope $P = \{x \in [0,1]^n : Ax \leq b\}$. We have results when we assume entries of the constraint matrix $A$ are nonnegative. We also have results when the linear constraints are replaced by a class of convex, monotone, read once constraints. You can find more information about our results through our [poster](files/Volume_Poster.pdf) and a draft of our [paper](files/Volume_Paper.pdf).
