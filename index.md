...
In the past year I have been working on obtaining a Fully Polynomial Time Approximation Scheme (FPTAS) for the volume of a polytope. I designe a deterministic algorithm that can compute an epsilon multiplicative approximation of the volume of a polytope $P = \{x \in [0,1]^n : Ax \leq b\}$. The results hold when we assume entries of the constraint matrix $A$ are nonnegative, as well as when the linear constraints are replaced by a class of convex, monotone, read once constraints. You can find more information about these results through our [poster](files/Volume_Poster.pdf) and my [paper](https://arxiv.org/abs/2605.19809).
